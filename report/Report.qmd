...
hist(as.numeric(dataHyp1_2$Creator_nb_projects), main = 'Histogram of Number of Projects Created (learning)')
...
```{r}
hist(as.numeric(dataHyp1_2$Creator_nb_backed), main = 'Histogram of Number of Projects Backed (learning)')
```

```{r}
hist(dataHyp1_2$Goal_percentage, main = 'Histogram of the Percentage of the Goal that was reached (success)')
```
