...
modD <- lm(innovation ~ orderFactor + Goal_USD + 
             duration + previousSuccess, 
           data=dataHyp2)
modE <- lm(innovation ~ Order + Goal_USD + 
             duration + previousSuccess + 
...
plot(mod4, which = 1)  # Residuals vs Fitted
plot(mod4, which = 2)  # Normal Q-Q plot
plot(mod4, which = 3)  # Scale-Location plot
plot(mod4, which = 4)  # Residuals vs Leverage
```

```{r}
par(mfrow = c(2,2), col.axis = "black", col.lab = "black", tck = 0)

plot(mod5, which = 1)  # Residuals vs Fitted
plot(mod5, which = 2)  # Normal Q-Q plot
plot(mod5, which = 3)  # Scale-Location plot
plot(mod5, which = 4)  # Residuals vs Leverage
```
...
plot(modD, which = 1)  # Residuals vs Fitted
plot(modD, which = 2)  # Normal Q-Q plot
plot(modD, which = 3)  # Scale-Location plot
plot(modD, which = 4)  # Residuals vs Leverage
```
...
plot(modE, which = 1)  # Residuals vs Fitted
plot(modE, which = 2)  # Normal Q-Q plot
plot(modE, which = 3)  # Scale-Location plot
plot(modE, which = 4)  # Residuals vs Leverage
```

```{r}
par(mfrow = c(2,2), col.axis = "black", col.lab = "black", tck = 0)

plot(modF, which = 1)  # Residuals vs Fitted
plot(modF, which = 2)  # Normal Q-Q plot
plot(modF, which = 3)  # Scale-Location plot
plot(modF, which = 4)  # Residuals vs Leverage
...
plot(modG, which = 1)  # Residuals vs Fitted
plot(modG, which = 2)  # Normal Q-Q plot
plot(modG, which = 3)  # Scale-Location plot
plot(modG, which = 4)  # Residuals vs Leverage
```

```{r}
par(mfrow = c(2,2), col.axis = "black", col.lab = "black", tck = 0)

plot(modH, which = 1)  # Residuals vs Fitted
plot(modH, which = 2)  # Normal Q-Q plot
plot(modH, which = 3)  # Scale-Location plot
plot(modH, which = 4)  # Residuals vs Leverage
```
...
```{r}
stargazer::stargazer(anova(modelPoissonInt), title = "Research Question 1: Poisson Model", align = TRUE)
```
